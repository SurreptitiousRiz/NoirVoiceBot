...
class vc(commands.Cog):
    ...
    async def private(self, ctx):
        ...
        if voice is None:
            ...
            await ctx.channel.send(f'{ctx.author.mention} Voice chat private! ðŸ”’')
        conn.commit()
        conn.close()
    ...
    async def public(self, ctx):
        ...
        if voice is None:
            ...
            await ctx.channel.send(f'{ctx.author.mention} Voice chat public! ðŸ”“')
        conn.commit()
        conn.close()
    ...
    async def reject(self, ctx, member : discord.Member):
        ...
        if voice is None:
            ...
            await ctx.channel.send(f'{ctx.author.mention} You have rejected {member.name} from accessing the channel. âŒ')
        conn.commit()
        conn.close()
